...
public class PoiSearchModule extends BaseModule implements OnGetPoiSearchResultListener{
    ...
    Callback poiSearchResultCallback;
     ...
     */
     @ReactMethod
    public void searchNearbyProcess(String keyWord,double lon,double lat,int radius,int loadIndex,Callback poiSearchResultCallback) {
        searchType = 2;
        this.center = new LatLng(lat, lon);
        this.poiSearchResultCallback = poiSearchResultCallback;
            ...
            if(poiList!=null && poiList.size()>0){
                ...
                for(int i = 0; i< poiList.size(); i++){
                    ...
                    if(i != poiList.size()-1){
                     ...
                     tempStr += ",";
                     tempStr += latLng.longitude;
                     tempStr += ",";
                     tempStr += latLng.latitude;
                     tempStr += ";";
                    }else{
                     tempStr += item.name;
                     tempStr += ",";
                ...
                this.poiSearchResultCallback.invoke(tempStr);
            }
            return;
        }
